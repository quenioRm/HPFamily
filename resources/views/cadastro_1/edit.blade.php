        ...
        <form action="{{route('cad1RegEdit', $data->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select name="status_payment" class="mb-3 form-control">
                    <option value="6" @if (old('status_payment', $data->status_payment) == "6") {{ 'selected' }} @endif>Pago 2/2</option>
                    <option value="5" @if (old('status_payment', $data->status_payment) == "5") {{ 'selected' }} @endif>Pago 1/2</option>
                    <option value="4" @if (old('status_payment', $data->status_payment) == "4") {{ 'selected' }} @endif>Pago 3/3</option>
                    <option value="3" @if (old('status_payment', $data->status_payment) == "3") {{ 'selected' }} @endif>Pago 2/3</option>
                    <option value="2" @if (old('status_payment', $data->status_payment) == "2") {{ 'selected' }} @endif>Pago 1/3</option>
